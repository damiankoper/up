...
%MOŻESZ DODAĆ WIĘCEJ LITERATURY 
%Jak się doda caption do listingów to się pojawia w spisie

% <3 KROKI <3:
% KONFIGURACJA
%   1 DO 1 NIE PO DHCP
% ODCZYTANIE PIERWSZEJ WARTOŚCI
%   TUTAJ OMÓWIĆ SZCZEGÓŁOWO TĘ FUNKCJĘ CO WYSYŁA TĘ RAMKĘ I POSZCZEGÓLNE BITY PORÓWNAĆ DO RAMKI OMAWIANEJ WYŻEJ
%   OMÓWIĆ ŻE PĘTLA JEST W ASYNCHRONICZNYM TASKU
%   OMÓWIĆ KROKI POTRZEBNE DO WYŚWIETLENIA WARTOŚCI, KONWERSJA, ITD
% ODCZYTANIE POZOSTAŁYCH POTRZEBNYCH KOLEJNYCH WARTOŚCI
%   JUŻ NIE SZCZEGÓŁOWO POKAZAĆ KOD DLA KOLEJNYCH WARTOŚCI
% WYLICZANIE active power I PORÓWNANIE DO Z OTRZYMANYM (TO TEŻ TYLKO ODPOWIEDNI FRAGMENT KODU)
% ZAPISYWANIE DO PLIKU I NARYSOWANIE WYKRESU (SAME FRAGMENTY ODPOWIEDZIALNE TYLKO ZA TO)
% POZOSTAŁE ELEMEMTY PROGRAMU (TUTAJ MOŻNA TĘ METODĘ RESETOWANIA WARTOŚCI ALBO WŁĄCZANIA NO TĘ Z BOOLAMI)

% NA KOŃCU MOŻNA CAŁY LISTING DAĆ W SUMIE PRÓCZ FRAGMENTÓW

% NO I GITARA BĘDZIE, TE DEFINICJE JEDNAK SPOKO TO JA JESTEM ZJEBANY :*
% W LITERATURZE DODAJ JAKIEŚ WIKI CZY COŚ XD I W TEKSCIE GDZIEŚ \cite
\subsection{Listing}
